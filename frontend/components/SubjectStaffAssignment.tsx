...
import { AssignStaffToSubject } from '@/apicalls/subjects';
...
const SubjectUserAssignment =(props: any)=>{
  ...
  const { mutate, error } = useMutation(
      ...
      AssignStaffToSubject(data, props.user_session.access_token),
    {
      onSuccess: async (data) => {
        showAlert('success', 'User assigned to subject Successfuly')
...
export default SubjectUserAssignment