                ...
                <ul>
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight duration={300} height={currentMenu === 'Admissions' ? 'auto' : 0}>
                      <ul className="sub-menu text-gray-500">
                        <li>
                          <Link href="/apps/invoice/list">{t('Create Admission')}</Link>
                        </li>
                        <li>
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight duration={300} height={currentMenu === 'Subjects' ? 'auto' : 0}>
                      <ul className="sub-menu text-gray-500">
                        <li>
                          <Link href="/apps/invoice/list">{t('Subject Lists')}</Link>
                        </li>
                        <li>
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight duration={300} height={currentMenu === 'Sessions' ? 'auto' : 0}>
                      <ul className="sub-menu text-gray-500">
                        <li>
                          <Link href="/apps/invoice/list">{t('Sessions Lists')}</Link>
                        </li>
                        <li>
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight duration={300} height={currentMenu === 'Examination' ? 'auto' : 0}>
                      <ul className="sub-menu text-gray-500">
                        <li>
                          <Link href="/apps/invoice/list">{t('Examination ')}</Link>
                        </li>
                        <li>
                ...
                <ul>
                  ...
                  <li className="menu nav-item">
                    ...
                    <AnimateHeight duration={300} height={currentMenu === 'Students' ? 'auto' : 0}>
                      <ul className="sub-menu text-gray-500">
                        <li>
                          <Link href="/apps/invoice/list">{t('Students')}</Link>
                        </li>
                        <li>
                          <Link href="/apps/invoice/preview">{t('Student Types')}</Link>
                        </li>
                        <li>
                          <Link href="/apps/invoice/preview">{t('Student Attendance')}</Link>
                        </li>
