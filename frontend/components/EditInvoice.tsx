import { editInvoice } from "@/apicalls/fees";
...
const EditInvoice = (props: EditInvoiceProps) => {
  const { register, handleSubmit, reset } = useForm<EditInvoiceFormvalues>({ shouldUseNativeValidation: true });
    ...
    <div>
      <form className="space-y-5" onSubmit={onSubmit}>
        ...
        <div>
          ...
          <input id="name" type="text" placeholder="Name" className="form-input" {...register("name", { required: false })} />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="amountPaid" type="number" placeholder="Amount Paid" className="form-input" {...register("amountPaid", { required: false })} />
        </div>
        <div>
          <label htmlFor="balance">Balance</label>
          <input id="balance" type="number" placeholder="Balance" className="form-input" {...register("balance", { required: false })} />
        </div>
        <div>
          <label htmlFor="outstandingBalance">Outstanding Balance</label>
          <input id="outstandingBalance" type="number" placeholder="Outstanding Balance" className="form-input" {...register("outstanding_balance", { required: false })} />
        </div>
