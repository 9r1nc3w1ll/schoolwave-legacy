            ...
            <div className="mb-5">
                <div className=" font-semibold">
                    <div className="rounded border border-[#d3d3d3] dark:border-[#1b2e4b]  ">
                        <div className={`justify-between md:flex ${props.active === props.i ? 'p-5' : ''}`}>
                            <h1 className={`flex w-full items-center p-4 text-white-dark dark:bg-[#1b2e4b] `} onClick={() => props.togglePara(props.i)}>
