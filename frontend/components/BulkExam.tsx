...
import { BulkSubjectsUpload } from "@/apicalls/subjects";

export default function BulkExamination(props:any){
  ...
  return(
    <div className="text-center">
      <h1 className="text-xl mb-6 text-primary">Bulk Subjects Upload</h1>
