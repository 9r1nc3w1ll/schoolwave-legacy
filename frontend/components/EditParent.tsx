...
const EditParent  = (props:any) => {
  ...
  const {data:parentData, isSuccess:parentDataSuccessful, status:parentDataStatus, isLoading:parentDataLoading} = useQuery('getStudent', ()=>{
    if(router){
          ...
          return (
            ...
            <div className='panel flex-1 px-3 py-6 ltr:xl:mr-6 rtl:xl:ml-6' > 
              <div className="w-full pt-0 mt-0 border-b-2 "> 
                <div className='pl-3 font-bold text-lg'> Edit Parent Details</div> 
              </div>
