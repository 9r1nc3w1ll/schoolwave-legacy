...
import SubjectUserAssignments from "@/components/Subb";
...
const Export = (props:any) => {
 ...
 useEffect(() =>{
  ...
  useEffect(() => {
    setInitialRecords(() => {
      if (isSuccess && subjects && subjects.length) {
        ...
        <td>
          ...
          >
            <div className="bg-[#f7f7f5] absolute bottom-0 left-0 text-left shadow-md mt-8 translate-x-[-105%] translate-y-[100%] w-[130px] z-10">
              <p
                className="mb-2 px-3 pt-2 cursor-pointer hover:bg-white"
                onClick={() => {
                  seteditModal(true);
              ...
              <p
                className="mb-2 px-2 cursor-pointer hover:bg-white"
                onClick={() => {
