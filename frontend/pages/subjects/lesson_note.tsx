...
import { CreateLesssonNote, getLesssonNote, editLessonNote, deleteLessonNote } from '@/api-calls/lesson-notes';
...
const Notes = () => {
  ...
  const {
    ...
    status: status2,
    refetch: refetch2,
  } = useQuery('getLessons', () => getLesssonNote(user_session?.access_token), {
    enabled: false,
  });
  useEffect(() => {
    refetch2();
  ...
  const setTag = async (note: any, name: string = '') => {
    try {
      ...
      const updatedList = filterdNotesList?.map((d: any) =>
        d.id === note.id ? updatedNote : d
      );
  ...
  const changeValue = (e: any) => {
    if (e.target) {
      ...
      setParams({
        ...
        last_updated_by: user_session?.id,
      });
    } else {
      let text = e;
      setParams({
  ...
  const deleteNote = async () => {
    try {
      ...
      const updatedList = notesList.filter(
        (d: Note) => d.id !== deletedNote.id
      );
      setFilterdNotesList(updatedList);
      refetch2();
              ...
              <div className='space-y-1'>
                ...
                >
                  <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                    className='h-3 w-3 rotate-45 fill-primary'
                  >
                    <path
                ...
                >
                  <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                    className='h-3 w-3 rotate-45 fill-warning'
                  >
                    <path
                      d='M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z'
                      stroke='currentColor'
                ...
                >
                  <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                    className='h-3 w-3 rotate-45 fill-info'
                  >
                    <path
                      d='M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z'
                      stroke='currentColor'
                ...
                >
                  <svg
                    ...
                    fill='none'
                    xmlns='http://www.w3.org/2000/svg'
                    className='h-3 w-3 rotate-45 fill-danger'
                  >
                    <path
                      d='M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z'
                      stroke='currentColor'
                    ...
                    >
                      <div className='min-h-[142px]'>
                        ...
                        <div>
                          ...
                          <p className='mt-2 text-white-dark'>
                            {note.description}
                          </p>
                        </div>
                      </div>
