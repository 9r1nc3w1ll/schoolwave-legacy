  ...
  return (
    <div className='panel min-h-[70%] '>
      <div className='mb-4 flex justify-between'>
        <div>
          <h1 className=' text-3xl font-semibold dark:text-white-light'>
            Attendance
          </h1>
          <p className='text-xs'>
            * Leave start date and end date as it is to get today&apos;s
            attendance
          </p>
        </div>
        ...
        <div className='mb-6 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2'>
          <div>
            <ClassSelect
              ...
              triggerFetch={sessionStatus == 'authenticated'}
            />
        ...
        <>
          {attendancegotten && attendance?.length ? (
            <AttendanceTable
              ...
              current_class={attendance[0]?.class_info}
              today={today}
            />
            ...
            <h1>
              {isLoading
                ? 'Loading...'
                : 'No data to display, adjust the filters and click update to fetch data'}
            </h1>
          )}
        </>
      ) : (
        <>
          <h1 className=' mt-6 text-xl font-semibold dark:text-white-light'>
            Attendance by day
          </h1>
          <div className='w-full'>
            {attendancegotten && attendance?.length ? (
              attendance[0]?.attendance.map(
                (student: { id: any }, i: number) => {
                  return (
                    <AttendanceAccordion
