...
<span className="badge badge-outline-dark">Dark</span>`}
        ...
        <div className="panel" id="pills">
          <div className="mb-5 flex items-center justify-between">
            <h5 className="text-lg font-semibold dark:text-white-light">Pills</h5>
            <button
              onClick={() => {
                toggleCode('code3');
              }}
...
<div className="flex items-center justify-center w-1/2">
    <span className="badge badge-outline-primary rounded-full">Primary</span>
        ...
        <div className="panel" id="classic">
          <div className="mb-5 flex items-center justify-between">
            <h5 className="text-lg font-semibold dark:text-white-light">Classic</h5>
            <button
              onClick={() => {
                toggleCode('code4');
              }}
...
<div className="flex items-center justify-center w-1/2">
    <span className="badge badge-outline-primary rounded-none">Primary</span>
        ...
        <div className="panel" id="with_headings">
          <div className="mb-5 flex items-center justify-between">
            <h5 className="text-lg font-semibold dark:text-white-light">Badges with Heading</h5>
            <button
              onClick={() => {
                toggleCode('code5');
              }}
    ...
    <h6>
        ...
        <div className="panel" id="custom">
          <div className="mb-5 flex items-center justify-between">
            <h5 className="text-lg font-semibold dark:text-white-light">Custom Badges</h5>
            <button
              onClick={() => {
                toggleCode('code6');
              }}
              ...
              <button type="button" className="btn btn-primary my-4">
                <span className="flex items-center">
                  <svg
                    ...
                    className="h-4.5 w-4.5 ltr:mr-1 rtl:ml-1"
                  >
