...
const KnowledgeBase = () => {
  ...
  return (
    <div>
      ...
      <div className="pt-5">
        <h2 className="my-5 text-center text-2xl font-bold md:text-5xl">Knowledge Base</h2>
        ...
        <p className="mb-14 text-center text-base font-semibold">Search instant answers & questions asked by popular users</p>
        <ul className="md:grid-cols-0 mb-10 grid grid-cols-2 justify-center gap-5 rtl:space-x-reverse md:flex md:gap-0 md:space-x-5">
          <li className="group rounded-md border border-[#ebedf2] bg-white p-4 py-10 text-center hover:shadow-[rgba(145,158,171,0.20)_0px_0px_2px_0px,_rgba(145,158,171,0.12)_0px_12px_24px_-4px] dark:border-[#191e3a] dark:bg-black md:w-[240px]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto h-16 w-16 text-primary">
              <path
                opacity="0.5"
          ...
          <li className="group rounded-md border border-[#ebedf2] bg-white p-4 py-10 text-center hover:shadow-[rgba(145,158,171,0.20)_0px_0px_2px_0px,_rgba(145,158,171,0.12)_0px_12px_24px_-4px] dark:border-[#191e3a] dark:bg-black md:w-[240px]">
            <svg className="mx-auto text-primary" width="64" height="64" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <h3 className="mb-5 text-center text-xl font-bold md:text-3xl">Some common questions</h3>

        <div className="mb-10 space-y-5">
          <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black ">
            <div className={`flex cursor-pointer p-5 font-semibold ${active === 1 ? 'text-primary' : ''}`} onClick={() => togglePara(1)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ltr:mr-4 rtl:ml-4">
                <path
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
            <div className={`flex cursor-pointer p-5 font-semibold ${active === 2 ? 'text-primary' : ''}`} onClick={() => togglePara(2)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ltr:mr-4 rtl:ml-4">
                <path
                  d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296"
                  stroke="currentColor"
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
            <div className={`flex cursor-pointer p-5 font-semibold ${active === 3 ? 'text-primary' : ''}`} onClick={() => togglePara(3)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ltr:mr-4 rtl:ml-4">
                <path
                  d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296"
                  stroke="currentColor"
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
            <div className={`flex cursor-pointer p-5 font-semibold ${active === 4 ? 'text-primary' : ''}`} onClick={() => togglePara(4)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ltr:mr-4 rtl:ml-4">
                <path
                  d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296"
                  stroke="currentColor"
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
            <div className={`flex cursor-pointer p-5 font-semibold ${active === 5 ? 'text-primary' : ''}`} onClick={() => togglePara(5)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ltr:mr-4 rtl:ml-4">
                <path
                  d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296"
                  stroke="currentColor"
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white dark:border-[#191e3a] dark:bg-black">
            <div className={`flex cursor-pointer p-5 font-semibold ${active === 6 ? 'text-primary' : ''}`} onClick={() => togglePara(6)}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ltr:mr-4 rtl:ml-4">
                <path
                  d="M17 7.82959L18.6965 9.35641C20.239 10.7447 21.0103 11.4389 21.0103 12.3296C21.0103 13.2203 20.239 13.9145 18.6965 15.3028L17 16.8296"
                  stroke="currentColor"
        ...
        <h3 className="mb-5 text-xl font-bold md:text-3xl">Popular Topics</h3>
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-md border border-[#ebedf2] bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),_0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#191e3a] dark:bg-black">
            <div className="mb-5 overflow-hidden rounded-md shadow-[0_6px_10px_0_rgba(0,0,0,0.14),_0_1px_18px_0_rgba(0,0,0,0.12),_0_3px_5px_-1px_rgba(0,0,0,0.20)]">
              <img src="/assets/images/lightbox1.jpg" alt="..." />
            </div>
            <h5 className="mb-5 text-xl">Excessive sugar is harmful</h5>
            <div className="flex">
              <div className="overflow-hidden rounded-full ltr:mr-4 rtl:ml-4">
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),_0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#191e3a] dark:bg-black">
            ...
            <h5 className="mb-5 text-xl">Creative Photography</h5>
            <div className="flex">
              <div className="overflow-hidden rounded-full ltr:mr-4 rtl:ml-4">
                <img src="/assets/images/profile-2.jpeg" className="h-11 w-11 object-cover" alt="profile2" />
              </div>
              <div className="flex-1">
                <h4>Alma Clark</h4>
                <p>06 May</p>
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),_0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#191e3a] dark:bg-black">
            ...
            <h5 className="mb-5 text-xl">Plan your next trip</h5>
            <div className="flex">
              <div className="overflow-hidden rounded-full ltr:mr-4 rtl:ml-4">
                <img src="/assets/images/profile-3.jpeg" className="h-11 w-11 object-cover" alt="profile3" />
              </div>
              <div className="flex-1">
                <h4>Alma Clark</h4>
                <p>06 May</p>
          ...
          <div className="rounded-md border border-[#ebedf2] bg-white p-5 shadow-[0px_0px_2px_0px_rgba(145,158,171,0.20),_0px_12px_24px_-4px_rgba(145,158,171,0.12)] dark:border-[#191e3a] dark:bg-black">
            ...
            <h5 className="mb-5 text-xl">My latest Vlog</h5>
            <div className="flex">
              <div className="overflow-hidden rounded-full ltr:mr-4 rtl:ml-4">
                <img src="/assets/images/profile-4.jpeg" className="h-11 w-11 object-cover" alt="profile4" />
              </div>
              <div className="flex-1">
                <h4>Alma Clark</h4>
                <p>06 May</p>
