            ...
            <div className="flex flex-1 items-start ltr:pr-4 rtl:pl-4">
              ...
              <div>
                ...
                <div className={`mt-2 flex items-center ${currentCoin.isUp ? 'text-success' : 'text-danger'}`}>
                  ...
                  {currentCoin.isUp && (
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" className="mb-px h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                        <path
                          fillRule="evenodd"
                  ...
                  {!currentCoin.isUp && (
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" className="mb-px h-4 w-4 text-danger" viewBox="0 0 20 20" fill="currentColor">
                        <path
                          fillRule="evenodd"
