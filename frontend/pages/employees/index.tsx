...
const Export = () => {
  ...
  const [isCreateEmployeeRoleOpen, setIsCreateEmployeeRoleOpen] =
    useState(false);
        ...
        <div className='mb-4.5 flex flex-col justify-between gap-5 md:flex-row md:items-center'>
          ...
          <div className='flex flex-wrap items-center'>
            ...
            <Transition appear show={isCreateEmployeeRoleOpen} as={Fragment}>
              <Dialog
                as='div'
                open={isCreateEmployeeRoleOpen}
                onClose={() => setIsCreateEmployeeRoleOpen(false)}
              >
                <Transition.Child
                  as={Fragment}
                  enter='ease-out duration-300'
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__fadeInDown my-8 w-full max-w-5xl overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark'>
                      <div className='mx-auto w-4/5 py-5'>
                        <CreateStaffRole
                          accessToken={userSession?.access_token as string}
                          close={setIsCreateEmployeeRoleOpen}
                          refreshList={refetch}
                        />
                      </div>
                    </Dialog.Panel>
