...
// teachersCountOptions
const teachersCount: any = {
  series: [34, 55],
  options: {
    chart: {
      height: 300,
    ...
    <div className='pb-10'>
      ...
      <div className="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
          <div className="flex justify-between">
            <div className="text-md font-semibold ltr:mr-1 rtl:ml-1">Current Session</div>
            <div className="dropdown">
              <Dropdown
                offset={[0, 5]}
                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
      ...
      <div className='grid grid-cols-2 gap-6'>
        ...
        <div>
          ...
          <ReactApexChart series={teachersCount.series} options={teachersCount.options} className="rounded-lg shadow-sm border-1 bg-white dark:bg-black overflow-hidden px-4 py-6 h-auto" type="pie" height={300} />
        </div>
      </div>
