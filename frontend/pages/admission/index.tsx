...
const Admission  = (props:any) => {
    ...
    (data) =>
      createUser(props.user_session.access_token, data),
    {
    ...
    <div className='px-2 py-4 '>
      ...
      <div className='my-3'> 
          ...
          <div className='my-3'> 
            ...
            <Flatpickr value={date1} {...register("date_of_birth",{ required: "This field is required" })}  options={{ dateFormat: 'Y-m-d' }} className="form-input" onChange={(date) => setDate1(date)} />
