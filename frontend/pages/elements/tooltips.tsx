        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="panel" id="default">
            ...
            {codeArr.includes('code1') && (
              <CodeHighlight>
                <pre className="language-typescript">{`import Tippy from '@tippyjs/react';
import 'tippy.js/dist/tippy.css';
    ...
    <button type="button" className="btn btn-success">
        Button
          ...
          <div className="panel" id="directions">
            <div className="mb-5 flex items-center justify-between">
              <h5 className="text-lg font-semibold dark:text-white-light">Placement</h5>
              <button
                onClick={() => {
                  toggleCode('code2');
                }}
...
<Tippy content="Popover on bottom" placement="bottom">
    <button type="button" className="btn btn-warning">
        Tooltip on bottom
          ...
          {/* Html popover */}
          <div className="panel lg:col-start-2 lg:row-start-1" id="dismissible">
            <div className="mb-5 flex items-center justify-between">
              <h5 className="text-lg font-semibold dark:text-white-light">HTML</h5>
              <button
                onClick={() => {
                  toggleCode('code3');
                }}
