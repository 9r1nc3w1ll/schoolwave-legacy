                        ...
                        button={
                          <>
                            ...
                            <svg
                              ...
                              className="inline-block h-4 w-4 rotate-180 ltr:ml-1 rtl:mr-1"
                            >
                              <path d="M19 9L12 15L5 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                          </>
                      ...
                      button={
                        <>
                          ...
                          <svg
                            ...
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            className="inline-block h-4 w-4 ltr:ml-1 rtl:mr-1 rtl:rotate-180"
                          >
                      ...
                      button={
                        <>
                          <svg
                            ...
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            className="inline-block h-4 w-4 ltr:mr-1 ltr:rotate-180 rtl:ml-1"
                          >
                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                                                    Left
                    ...
                    <Dropdown
                      ...
                      button={
                        <>
                                                    Small Button
                          <span>
                            <svg className="inline-block h-4 w-4 ltr:ml-1 rtl:mr-1 rtl:rotate-180" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M19 9L12 15L5 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                          </span>
                        </>
