...
import { getStudentsList } from '@/api-calls/schools';
...
const Export = (props: any) => {
  ...
  const {
    ...
    'getStudents',
    () => {
      return getStudentsList(session?.access_token ?? '');
    },
    {
      enabled: false,
    }
      ...
      <div className='panel'>
        ...
        <div className='datatables'>
          <DataTable
            ...
            onRowClick={(x: any) => router.push('/students/' + x.id)}
