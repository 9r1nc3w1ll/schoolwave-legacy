                ...
                <div className='grid-cols-3 gap-1 md:grid'>
                  ...
                  <div className='col-span-2'>
                    <h1 className='text-4xl text-primary '>
                      {toUpper(student.first_name) +
                        ' ' +
                        toUpper(student.last_name)}
                    </h1>
                    <div className='ml-[-35%] w-full grid-cols-2 gap-6 md:grid'>
                      <div>
                        <p className='mt-4 text-right '>Gender: </p>
                        <p className='mt-4 text-right '>Date of Birth: </p>
                        <p className='mt-4 text-right '>Religion: </p>
                        <p className='mt-4 text-right '>Class: </p>
                        <p className='mt-4 text-right '>Parent: </p>
                        <p className='mt-4 text-right '> Phone No.: </p>
                        <p className='mt-4 text-right '>Address.: </p>
                      </div>
                      <div className=''>
                        <p className='mt-4 text-left '>{student.gender}</p>
                        <p className='mt-4 text-left '>
                          {student.date_of_birth}
                        </p>
                        <p className='mt-4 text-left '>{student.religion}</p>
                        <p className='mt-4 text-left '>Basic Two Jade</p>
                        <p className='mt-4  text-left'>
                        ...
                        <p className='mt-4  text-left'>{student.address}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className='flex min-h-screen items-start justify-center px-4'>
                    <Dialog.Panel className='panel animate__animated animate__slideInDown my-8 w-full max-w-5xl overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark'>
                      <EditUser
                        type='student'
                        studentData={student}
