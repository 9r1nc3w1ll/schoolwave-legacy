    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percentage', models.IntegerField(blank=True, default=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='fees.discount')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.school')),
            ],
            options={
                'db_table': 'fee_item',
