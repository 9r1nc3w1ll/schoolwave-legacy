    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.SlugField(max_length=10, null=True, unique=True)),
                ('website_url', models.URLField(null=True)),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='school_owner', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'schools',
            },
